           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="img/personal-1.jpg" alt="">
							</div>
        		...
        		<div class="row welcome_inner">
        			<div class="col-lg-6">
        				<div class="welcome_text">
        					<h4>About Myself</h4>
        					<p>I am student who is studing B.Sc in CSE.Now trying to gain skills from <a href="http://adovasoft.com/"> AdovaSoft</a>.Learning things from everyone & everywhere.</p>
        					<p>One thing I believe that "Doing the right thing at the wrong time is also wrong". </p>
        					<div class="row">
        						<div class="col-md-4">
        							<div class="wel_item">
        				...
        				<div class="tools_expert">
        					<div class="skill_main">
								<div class="skill_item">
									<h4>PHP (Raw/Frameworks) <span class="counter">40</span>%</h4>
								...
								<div class="skill_item">
									<h4>C / C++ <span class="counter">50</span>%</h4>
									<div class="progress_br">
										<div class="progress">
								...
								<div class="skill_item">
									<h4>Web development <span class="counter">25</span>%</h4>
									<div class="progress_br">
										<div class="progress">
								...
								<div class="skill_item">
									<h4>MicroSoft (Office) <span class="counter">50</span>%</h4>
									<div class="progress_br">
										<div class="progress">
											<div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
								...
								<div class="skill_item">
									<h4>Adobe Photoshop <span class="counter">30</span>%</h4>
									<div class="progress_br">
										<div class="progress">
						...
						<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
							<ul class="list">
								<li>
									...
									<div class="media">
										<div class="d-flex">
											<p>November 2019 to present</p>
										</div>
										<div class="media-body">
											<h4>Adovasoft</h4>
											<p>Junior Programmer <br />Shamoly,Dhaka</p>
										</div>
									</div>
								</li>
								<li>
									...
									<div class="media">
										<div class="d-flex">
											<p>July 2018 to August 2019</p>
										</div>
										<div class="media-body">
											<h4>Prince Multiperpose co-Operative Ltd.</h4>
											<p>Loan Officer<br />23-Dhalpur,Jatrabari,Dhaka</p>
										</div>
									</div>
								</li>
								<li>
							...
							<ul class="list">
								<li>
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<p>B.Sc in CSE<br />Green Road,Tejgaon,Dhaka</p>
										</div>
									</div>
								</li>
								<li>
									...
									<div class="media">
										...
										<div class="media-body">
											<h4>Kabi Nazrul Govt. College</h4>
											<p>Science
											<br/>3.83 out of 5.00</p>
										</div>
									</div>
								</li>
								<li>
								<span></span>
									<div class="media">
										...
										<div class="media-body">
											<h4>Kasim Nagar High School</h4>
											<p>Science
											<br/>5.00 out of 5.00</p>
										</div>
									</div>
								</li>
							</ul>
        ...
        <section class="home_gallery_area p_120">
        	<div class="container">
        		<div class="main_title">
        			...
        			<p>All are Web development type Projects</p>
        		</div>
        		<div class="isotope_fillter">
        			<ul class="gallery_filter list">
						<li class="active" data-filter="*"><a href="#">All</a></li>
						<li data-filter=".brand"><a href="#">Recent</a></li>
					</ul>
        		</div>
        	</div>
        	<div class="container">
        		<div class="gallery_f_inner row imageGallery1">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid lol" src="img/gallery/project-2.jpg" alt="">
        						<a class="light" href="img/gallery/project-2.jpg"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<a href="http://robin.adovasoft.com/Final_Stock/">
        							<h4>Stock Managmment System</h4>
        						</a>
        						<p>Developed By <a href="https://www.facebook.com/sajib.adhikery.5">Sajib Adhikary</a><br/>&<b> Me </b></p>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-4 col-md-4 col-sm-6 manipul creative design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid lol" src="img/gallery/project-3.jpg" alt="">
        						<a class="light" href="img/gallery/project-3.jpg"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<a href="http://robin.adovasoft.com/Beginningworks/">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid lol" src="img/gallery/project-4.jpg" alt="">
        						<a class="light" href="img/gallery/project-4.jpg"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<a href=""><h4>String to Binary Convertion</h4>
        						<p>Project made by using JavaScript</p></a>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid lol" src="img/gallery/project-5.jpg" alt="">
        						<a class="light" href="img/gallery/project-5.jpg"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<a href=""><h4>Log in Panel</h4>
        						<p>Demo Bootstrap Project</p></a>
        					</div>
        				</div>
        			</div>
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid lol" src="img/gallery/project-6.jpg" alt="">
        						<a class="light" href="img/gallery/project-6.jpg"><img src="img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        						<a href=""><h4>String to Binary Convertion</h4>
        						<p>Project made by using PHP</p></a>
        					</div>
        				</div>
        			</div>
        		</div>
